...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy | Twin Cities Home Buyers" },
      {
        name: "description",
        content:
          "Read the privacy policy for Twin Cities Home Buyers. Learn how we collect, use, and protect your personal information.",
      },
    ],
  }),
});
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-10 text-sm leading-relaxed text-foreground/80">
          <section>
            ...
            <p className="mt-3">
              When ordering or registering on our site, as appropriate, you may be asked to enter your: name, e-mail address, mailing address or phone number. You may, however, visit our site anonymously. We transfer information about you if Twin Cities Home Buyers, Inc. is acquired by or merged with another company. In this event, Twin Cities Home Buyers, Inc. will notify you before information about you is transferred and becomes subject to a different privacy policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Twin Cities Home Buyers, Inc. also may use 3rd party vendor re-marketing tracking cookies, including but not limited to the Google Adwords tracking cookie. This means we will continue to show ads to you across the internet, specifically on the Google Content Network (GCN). As always we respect your privacy and are not collecting any identifiable information through the use of Google's or any other 3rd party remarketing system.
            </p>
            <p className="mt-3">

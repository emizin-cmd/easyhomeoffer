...
export const Route = createFileRoute("/sell-your-house-as-is")({
  ...
  head: () =>
    buildSeo({
      ...
      description:
        "We buy Twin Cities houses exactly as they are. No repairs, no cleanouts, no inspections. Fair cash offer in 24 hours. Close in as little as 7 days.",
    }),
});
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 py-10 md:py-20 lg:grid-cols-[1.1fr_1fr] lg:py-28">
          <div>
            ...
            <p className="mx-auto mt-4 max-w-xl text-center text-base leading-relaxed text-muted-foreground md:mt-6 md:text-lg lg:mx-0 lg:text-left">
              ...
              &amp; St. Paul houses in any condition — even with leftover belongings,
              deferred maintenance, or full-on “fixer-upper” status.
            </p>
      ...
      <section className="relative py-10 md:py-16">
        ...
        <div className="mx-auto max-w-3xl px-6">
          <div className="space-y-5 text-[15px] leading-relaxed text-foreground/80">
            <p>
              Listing on the MLS means inspections, repair negotiations, contingency
              clauses, and buyers who walk if the appraisal comes in low. None of
              that happens here. We make a fair all-cash offer based on the house’s
              real condition — and that offer is what closes.
            </p>
            <p>
              Old roof? We’ll handle it. Outdated kitchen, water damage, a tenant
              who never left? Leave the place exactly as it sits. You don’t need to
              take photos, you don’t need to stage, you don’t even need to clean.
            </p>
            <p>
              Tell us a little about the property and we’ll come back within 24
              hours with a no-obligation offer.
            </p>
          </div>
        </div>
      </section>

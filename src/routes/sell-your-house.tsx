        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 py-10 md:py-20 lg:grid-cols-[1.1fr_1fr] lg:py-28">
          <div>
            <div className="flex justify-center">
              <SectionLabel>Fast cash offer · No obligations</SectionLabel>
            </div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-5">
              <a
                href={`tel:${PHONE_TEL}`}
                className="inline-flex items-center gap-2 rounded-full bg-foreground px-6 py-3.5 text-sm font-semibold text-background shadow-lg transition hover:translate-y-[-1px]"
              >
              ...
              <Link
                to="/contact-us"
                className="inline-flex items-center gap-2 rounded-full border border-border px-6 py-3.5 text-sm font-semibold transition hover:bg-secondary"
              >
                Contact us

    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-10 md:py-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-1 sm:gap-6 md:mt-12 lg:grid-cols-3">
            {STEPS.map((step) => {
              const Icon = step.icon;
              return (
                <div
                  key={step.n}
                  className="group relative overflow-hidden rounded-2xl border border-border bg-card p-4 shadow-[var(--shadow-soft)] transition hover:-translate-y-1 hover:border-primary/30 hover:shadow-lg md:p-7"
                >
                  <div
